            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td style="text-align: left; width: 9%">
                        ...
                        <asp:LinkButton ID="LinkButton2" runat="server" OnClientClick="return confirm('Confirm delete?')" CommandName="delete" CommandArgument='<%# Eval("assessID") %>' ForeColor="Green">Delete</asp:LinkButton>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td style="text-align: left; width: 9%">
                        ...
                        <asp:LinkButton ID="LinkButton4" runat="server" OnClientClick="return confirm('Confirm delete?')" CommandName="delete" CommandArgument='<%# Eval("assessID") %>' ForeColor="Green">Delete</asp:LinkButton>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
